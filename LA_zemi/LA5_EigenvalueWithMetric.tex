...
\begin{document}
    ...
    \subsection*{問題2}
        ...
        \end{equation*}
    \subsection*{問題3}
        $g(t)$を任意の多項式, $\alpha_1,\dots,\alpha_n$を$n$次正方行列$A$の固有値とする. このとき, $g(A)$の固有値は$g(\alpha_1),\dots,g(\alpha_n)$であることを示せ. (\textbf{Frobeniusの定理})
    \subsection*{問題4}
        次の問に答えよ. 
        \begin{enumerate}
        ...
        \end{enumerate}
    \subsection*{問題5}
        対称行列の相異なる固有値に対する固有ベクトルは互いに直交することを示せ.
    \subsection*{問題6}
    ...
    \subsection*{問題7}
        ...
        \end{equation*}
        この式を用いて, 極値を取りうる点でHessianが正なら極値点となり, 負なら鞍点となることを示せ. また, 特に極値を取るときの$f_{xx}$の符号と極大値, 極小値の関係を示せ. (注.$\left(\Delta x\frac{\partial}{\partial x}+\Delta y\frac{\partial}{\partial y}\right)^2=\Delta x^2\frac{\partial^2}{\partial x^2}+2\Delta x\Delta y\frac{\partial^2}{\partial x\partial y}+\Delta y^2\frac{\partial^2}{\partial y^2}$)
    \subsection*{補充問題}
